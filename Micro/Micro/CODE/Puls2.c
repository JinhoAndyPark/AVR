...
{
  setRegBitGroup(TMRA1_CTRL,CM,0);     /* Stop counter */
  return ERR_OK;                       /* OK */
}
...
{
  *Value = getReg(TMRA1_CNTR);         /* Return counter value */
}
...
{
  /* TMRA1_CTRL: CM=0,PCS=1,SCS=0,ONCE=0,LENGTH=0,DIR=0,Co_INIT=0,OM=0 */
  setReg(TMRA1_CTRL,0x0200);           /* Set up mode */
